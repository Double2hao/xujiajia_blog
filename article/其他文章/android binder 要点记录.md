...
<img src="https://raw.githubusercontent.com/Double2hao/xujiajia_blog/main/img/2520.png" alt="在这里插入图片描述"> 图中Client/Server/ServiceManage之间的相互通信都是基于Binder机制。既然基于Binder机制通信，那么同样也是C/S架构，则图中的3大步骤都有相应的Client端与Server端。
